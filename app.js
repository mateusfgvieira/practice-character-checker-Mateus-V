...
let input = readline.question('Please enter the word or phrase you would like to index: ');

//2. Prompt a user for an index number to find the character at that index
let indexValue = readline.questionInt('Please enter the index value you would like to return: ');

//3. Use bracket notation to access the character
let output = input[indexValue];
